...
## Concert
This gitops repo exemplies how ConcertDef Deploy Inventory files can be automatically generated and uploaded to a Concert instance via custom pipelines in response to push events.
